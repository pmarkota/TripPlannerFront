...
export const Register = () => {
  ...
  return (
    <>
      <div className="display justify-center items-center h-screen bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-violet-200 via-fuchsia-500 to-yellow-500">
